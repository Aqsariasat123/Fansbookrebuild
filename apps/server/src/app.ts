  ...
  helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        imgSrc: ["'self'", 'data:', 'blob:', 'https://*.didit.me'],
        connectSrc: ["'self'", 'wss:', 'ws:', 'https://*.didit.me'],
        mediaSrc: ["'self'", 'blob:'],
        frameSrc: ["'self'", 'https://*.didit.me'],
      },
    },
...
app.post('/api/verification/webhook', express.raw({ type: '*/*' }), verificationWebhookHandler);
