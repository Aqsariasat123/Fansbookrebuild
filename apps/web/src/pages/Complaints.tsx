    ...
    <div className="min-h-screen font-outfit">
      ...
      <div className="bg-muted px-[20px] py-[40px] md:px-[76px] md:py-[80px] lg:px-[142px]">
        <div className="mx-auto max-w-[900px] text-[16px] leading-[1.8] text-foreground">
          ...
          <div className="mb-[32px] space-y-[16px]">
            <p>
              <strong>6.1</strong> Fansbook is committed to resolving your issues at the first point
              of contact; however, this will not be possible in all circumstances, in which case a
              more formal complaints process will be followed.
            </p>
            <p>
              <strong>6.2</strong> Fansbook will acknowledge receipt of your complaint within three
              (3) business days. Once your complaint has been received, we will undertake an initial
              review of your complaint.
            </p>
            <p>
              <strong>6.3</strong> There may be circumstances during the initial review or
              investigation of your complaint where we may need to clarify certain aspects of your
              complaint or request additional documentation from you. In such circumstances we will
              explain the purpose of seeking clarification or additional documentation and provide
              you with feedback on the status of your complaint at that time.
            </p>
            <p>
              <strong>6.4</strong> Fansbook is committed to resolving your complaint within 7
              business days of you lodging your complaint, however, this may not always be possible
              on every occasion. Where we have been unable to resolve your complaint within 7
              business days, we will inform you of the reason for the delay and specify a date when
              we will be in a position to finalize your complaint.
            </p>
            <p>
              <strong>6.5</strong> During the initial review or investigation stage we may need to
              seek further clarification from you to assist us in resolving your complaint.
            </p>
            <p>
              <strong>6.6</strong> If we have sought clarification from you and we are waiting on
              you to provide this information, we may not be able to meet our 7 business day
              finalization commitment. In such circumstances upon receipt of your clarification we
              will indicate to you when we expect to be able to finalize your complaint.
            </p>
            <p>
              <strong>6.7</strong> Once we have finalized your complaint, we will advise you of our
              findings and any action we have taken. We will do this in writing, unless it has been
              mutually agreed that we can provide it to you verbally.
            </p>
            <p>
              <strong>6.8</strong> You have the right to make enquiries about the current status of
              your complaint at any time by contacting us.
            </p>
          </div>
