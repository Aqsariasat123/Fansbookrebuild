    ...
    <div className="min-h-screen font-outfit">
      ...
      <div className="bg-muted px-[20px] py-[40px] md:px-[76px] md:py-[80px] lg:px-[142px]">
        <div className="mx-auto max-w-[900px] text-[16px] leading-[1.8] text-foreground">
          <h2 className="mb-[24px] text-[36px] font-medium">Cookie Policy</h2>
          ...
          <div className="mb-[32px] space-y-[16px]">
            ...
            <p>
              <strong>2.2 Information Collected Automatically.</strong> When you use our site, we
              automatically collect certain information by the interaction of your mobile device or
              web browser with our platform.
            </p>
            <p>
              <strong>2.3 Cookies.</strong> Like many other sites, we use "Cookies." A Cookie is a
              small piece of data stored on your computer or mobile device by our site. We use
              Cookies to identify the areas of our site that you have visited. We also use cookies
              to enhance your online experience by eliminating the need to log in multiple times for
              specific content. Finally, we may use Cookies to personalize the content that you see
            ...
            <p>
              ...
              used to identify you personally, even if you are not signed in to our site.
            </p>
          </div>
          ...
          <div className="mb-[32px] space-y-[16px]">
            <p>
              ...
              communications you will receive with us, and the ability to change those choices
              whenever you want.
            </p>
            <p>
              <strong>3.1 Information we process with your consent.</strong> Through certain actions
              when otherwise there is no contractual relationship between us, such as when you
              browse our site or ask us to provide you more information about our business, you
              provide your consent to us to process information that may be personally identifiable
              information. Wherever possible, we aim to obtain your explicit consent to process this
              information, for example, by asking you to agree to our use of Cookies or to receive
              communications from us. We continue to process your information on this basis until
              you withdraw your consent or it can be reasonably assumed that your consent no longer
              exists. You may withdraw your consent at any time by instructing us using the contact
              information at the end of this Policy. However, if you do so, you may not be able to
              use our site further.
            </p>
            <p>
              <strong>3.2 Legally Required Releases of Information.</strong> We may be legally
              required to disclose your personally identifiable information, if such disclosure is
              (a) required by law, or other legal process; (b) necessary to assist law enforcement
              officials or government enforcement agencies; (c) necessary to investigate violations
              of or otherwise enforce our Legal Terms; (d) necessary to protect us from legal action
              or claims from third parties including you; and/or (e) necessary to protect the legal
              rights, personal/real property, or personal safety of our company, clients, third
              party partners, employees, and affiliates.
            </p>
          </div>
          ...
          <div className="mb-[32px] space-y-[16px]">
            ...
            <p>
              <strong>4.2 Remove or Change your Information.</strong> If you wish us to remove or
              change personally identifiable information that you have provided us, you may contact
              us at the contact information at the end of this Policy or if available through a tool
              on our site.
            </p>
            <p>
              <strong>4.3 Verification of your Information.</strong> When we receive any request to
              access, edit or delete personally identifiable information, we will first take
          ...
          <p className="mb-[32px]">
            You assume the sole risk of transmitting your information as it relates to the use of
            this site, and for any data corruptions, intentional interceptions, intrusions or
            unauthorized access to information, or of any delays, interruptions to or failures
            preventing the use this site. In no event shall we be liable for any direct, indirect,
            special, consequential or monetary damages, including fees, and penalties in connection
            with your use of materials posted on this site or connectivity to or from this site to
            any other site.
          </p>

          <h3 className="mb-[16px] text-[24px] font-medium">7. Protecting Your Child's Privacy</h3>
          <p className="mb-[32px]">
            Even though our site is not designed for use by anyone under the age of 18, we realize
            that a child may attempt to access the site. We do not knowingly collect personally
            identifiable information from a child. If you are a parent or guardian and believe your
            child is using our site, please contact us. We may ask for proof of identification
            before we remove any information to prevent malicious removal of information. If we
            discover on our own that a child is accessing our site, we will delete the information
            as soon as we discover it, we will not use the information for any purpose, and we will
            not disclose the information to third parties. You acknowledge that we do not verify the
            age of our users nor do we have any liability to do so. If you are a child, please seek
            the permission of a parent or guardian before accessing the site.
          </p>
