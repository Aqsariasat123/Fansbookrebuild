...
export default function About() {
  return (
    <div className="min-h-screen font-outfit">
      ...
      <div className="w-full bg-muted px-[20px] py-[40px] md:px-[76px] md:py-[67px] lg:px-[142px]">
        ...
        <div className="mt-[40px] flex w-full max-w-[1225px] flex-col items-center gap-[30px] lg:flex-row lg:items-start lg:justify-between lg:gap-0">
          ...
          <div className="flex w-full max-w-[603px] flex-col items-center">
            ...
            <div className="flex h-[56px] w-[190px] md:h-[96px] md:w-[327px] items-center justify-center rounded-t-[12px] md:rounded-t-[22px] bg-[#a61651]">
              <span className="text-[20px] md:text-[36px] font-medium text-foreground">
                Mission
              </span>
            </div>
            {/* Card body */}
            <div className="flex h-auto min-h-[200px] lg:h-[323px] w-full rounded-[13px] md:rounded-[22px] bg-muted px-[16px] py-[24px] md:px-[34px] md:py-[82px]">
              <div className="flex flex-col items-center gap-[24px] md:flex-row md:gap-[47px]">
                <img
                  src="/icons/about/goal.svg"
                  alt=""
          ...
          <div className="flex w-full max-w-[603px] flex-col items-center">
            {/* Pink tab — 327px centered above card */}
            <div className="flex h-[56px] w-[190px] md:h-[96px] md:w-[327px] items-center justify-center rounded-t-[12px] md:rounded-t-[22px] bg-[#a61651]">
              <span className="text-[20px] md:text-[36px] font-medium text-foreground">Vision</span>
            </div>
            {/* Card body */}
            <div className="flex h-auto min-h-[200px] lg:h-[323px] w-full rounded-[13px] md:rounded-[22px] bg-muted px-[16px] py-[24px] md:px-[34px] md:py-[72px]">
              <div className="flex flex-col items-center gap-[24px] md:flex-row md:gap-[47px]">
                <img
                  src="/icons/about/light_on.svg"
                  alt=""
                  className="h-[60px] w-[60px] md:h-[132px] md:w-[132px] shrink-0"
                />
                <p className="w-full md:w-[356px] text-[10px] md:text-[16px] font-medium leading-normal text-foreground">
