      ...
      <div className="bg-muted px-[20px] py-[40px] md:px-[76px] md:py-[80px] lg:px-[142px]">
        <div className="mx-auto max-w-[900px] text-[16px] leading-[1.8] text-foreground">
          ...
          <p className="mb-[32px]">
            ...
            paying subscribers ("Service"). These Terms of Service, together with our Privacy Policy
            ("Terms"), govern your use of Fansbook, including any content, functionality, and
            services offered on or through the website. By registering with and using Fansbook, you
            hereby accept and agree to be bound by and abide by these Terms. If you do not want to
            agree to these Terms, you must not access or use the website. This website is offered
            and available to users who are 18 years of age or older. By using this website, you
            represent and warrant that you are of legal age to form a binding contract with us and
          ...
          <p className="mb-[32px]">
            ...
            registration will be held and used in accordance with Fansbook's Privacy Policy. You are
            responsible for maintaining the confidentiality of your log-in credentials in order to
            use the Service and are fully responsible for all activities that occur through the use
            of your credentials. You agree to notify Fansbook immediately of any unauthorized use of
            your log-in credentials or any other breach of security with respect to your account.
            Fansbook will not be liable for any loss or damage arising from unauthorized use of your
            credentials prior to you notifying Fansbook of such unauthorized use or loss of your
            credentials.
          </p>
          ...
          <div className="mb-[32px] space-y-[16px]">
            ...
            <p>
              <strong>3.4</strong> Customer can cancel subscription any time on Creators' page by
              clicking Unsubscribe button. If there are any issues, customer should contact us first
              via email/social media. Customer agrees not to open dispute with Credit Card Company
              before making efforts to contact us to solve any issues/refund requests. We usually
          ...
          <p className="mb-[16px]">
            ...
            individuals (1) who are at least 18-years old and (2) who have reached the age of
            majority where they live may access the Website. If you do not meet these age
          ...
          <p className="mb-[32px]">
            ...
            genitals, fully exposed buttocks and female breasts if they include the nipple except if
            the women are breastfeeding or showing post-mastectomy scars. If the material is marked
            as 18+ and it is not, it may be refunded back to customer without warning and such post
            removed. Falsely marking posts as 18+, may lead to suspension of Creators' account.
          </p>

          <h3 className="mb-[16px] text-[24px] font-medium">5. Content You Submit</h3>
          <div className="mb-[32px] space-y-[16px]">
            <p>
              <strong>5.1 User Content.</strong> This Section governs any material that you post,
              send or transmit (collectively, "Post") through the Service, including, by way of
              ...
              (collectively, "User Content"). You are solely responsible for securing the rights to
              any and all User Content You Post to or through the Service.
            </p>
            <p>
              <strong>5.2 License Grants to Fansbook and other Users.</strong> BY POSTING USER
              CONTENT TO OR THROUGH THE SERVICE, YOU HEREBY GRANT TO FANSBOOK AN UNRESTRICTED,
              PERPETUAL, ASSIGNABLE, SUBLICENSABLE, REVOCABLE, ROYALTY-FREE, FULLY PAID UP LICENSE
              THROUGHOUT THE WORLD TO REPRODUCE, MODIFY, DISTRIBUTE, DISPLAY, PUBLISH, TRANSMIT,
              COMMUNICATE TO THE PUBLIC, MAKE AVAILABLE, BROADCAST, CREATE DERIVATIVE WORKS FROM,
              PUBLICLY PERFORM (INCLUDING ON A THROUGH-TO-THE AUDIENCE BASIS), DELIVER AND PUBLICLY
              PERFORM DIGITAL PHONE RECORDS, AND OTHERWISE USE AND EXPLOIT (COLLECTIVELY, "USE") ALL
              USER CONTENT YOU POST TO OR THROUGH THE SERVICE.
            </p>
            <p>
              <strong>5.3 License for Name, Image, Voice, and Likeness.</strong> You further hereby
              grant Fansbook a royalty-free license to Use your name, image, voice, trademarks,
              logos, monikers, and likeness (and that of any person identifiable in any User Content
              you posted to or through the Service) made available by or on your behalf through the
              Service in conjunction with your User Content. The foregoing license in the
              immediately preceding sentence will survive the termination of your account with
              respect to any of your User Content Posted to the Service prior to such termination.
            </p>
            <p>
              <strong>5.4 Limited Waiver of Rights.</strong> You waive any and all rights of
              privacy, rights of publicity, or any other rights of a similar nature in connection
              with your User Content, or any portion thereof. To the extent any moral rights are not
              transferable or assignable, you hereby waive and agree never to assert any and all
              moral rights, or to support, maintain or permit any action based on any moral rights
              that you may have in or with respect to any of your User Content Posted to the
          ...
          <div className="mb-[32px] space-y-[16px]">
            <p>
              ...
              reasonable legal and accounting fees, arising out of or in any way connected to (a)
              your access, use, or misuse of the Service, or Fansbook Content; (b) your User
              Content; or (c) your violation of this agreement.
            </p>
            <p>
              <strong>7.2</strong> Fansbook will use reasonable efforts to notify you of any such
              claim, action or proceeding for which it seeks an indemnification from you upon
              becoming aware of it, but if Fansbook is unable to communicate with you in a timely
              manner because of an inactive e-mail address for you, your indemnification obligation
              will continue notwithstanding Fansbook's inability to contact you in a timely manner.
            </p>
            <p>
              <strong>7.3</strong> Fansbook reserves the right to assume the exclusive defense and
              control of any matter that is subject to indemnification under this Section. In such
              case, you agree to cooperate with any reasonable requests to assist Fansbook's defense
              of such matter. You agree not to settle any matter without the prior express written
              consent of Fansbook.
            </p>
          </div>
          ...
          <div className="mb-[32px] space-y-[16px]">
            <p>
              <strong>8.1</strong> If payment has a chargeback from the credit card company
              (customer refunds) money is returned back to the client and deducted from Creators'
              account. We reserve the right to remove any fraudulent charges from Creators' balance
              and refund back to credit card owner.
            </p>
            <p>
          ...
          <div className="mb-[32px] space-y-[16px]">
            ...
            <p>
              <strong>9.2</strong> We do not allow selling any services outside the scope of
              services offered by this platform, such as ecommerce items.
            </p>
          </div>
        </div>
      </div>
