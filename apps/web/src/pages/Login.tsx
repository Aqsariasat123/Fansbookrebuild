  ...
  return (
    <div className="relative flex h-screen w-screen overflow-hidden font-outfit">
      ...
      <div className="relative z-10 flex w-full items-center justify-center px-[20px] lg:w-[54.77%] lg:ml-auto lg:px-0">
        <div className="w-full max-w-[336px] flex flex-col items-center rounded-[22px] bg-[#f8f8f8] px-[22px] py-[21px] lg:max-w-[392px] lg:rounded-none lg:bg-transparent lg:px-0 lg:py-0 lg:shadow-none">
          {/* Heading */}
          <div className="w-full text-center">
            <h1 className="font-medium text-[36px] leading-[1.25] text-[#15191c] lg:text-[48px]">
              Welcome Back to FansBook
            </h1>
            <p className="mt-[21px] text-[12px] font-normal leading-[1.25] text-[#15191c] lg:mt-[27px] lg:text-[16px]">
              Log in to connect with your favorite creators and unlock
              exclusive content.
            </p>
          </div>
          ...
          >
            ...
            <div className="mt-[14px] lg:mt-[20px]">
              ...
              <p className="mt-[6px] text-right lg:mt-[8px]">
                <Link
                  to="/forgot-password"
                  className="text-[10px] font-normal text-[#01adf1] hover:underline lg:text-[12px]"
                >
                  Forgot Password?
                </Link>
              </p>
          ...
          {/* Sign Up Link */}
          <p className="mt-[20px] text-[12px] font-normal text-[#15191c] lg:mt-[40px] lg:text-[16px]">
