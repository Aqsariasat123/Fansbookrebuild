...
export default function LiveBroadcasting() {
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      {/* About */}
      <div>
        <p className="text-[18px] font-semibold text-[#f8f8f8]">About Live Stream</p>
      ...
      <div className="grid grid-cols-1 gap-[20px] lg:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-[16px] border border-[#e91e8c]">
          ...
          <div className="relative flex aspect-video items-center justify-center bg-[#0a0c0e]">
            <div className="flex flex-col items-center gap-[8px]">
              ...
              <p className="text-[14px] text-[#5d5d5d]">Live stream preview</p>
            </div>
        ...
        <div className="flex flex-col overflow-hidden rounded-[16px] border border-[#e91e8c]">
          ...
          {/* Chat Messages */}
          <div
            className="flex flex-1 flex-col gap-[16px] bg-[#0e1012] p-[16px]"
            style={{ minHeight: 250 }}
          >
            {messages.map((m) => (
              <div key={m.id} className={`flex ${m.isMine ? 'justify-end' : 'justify-start'}`}>
                {!m.isMine && (
                  <div className="flex gap-[10px]">
                    ...
                    <div>
                      <p className="mb-[4px] text-[12px] font-medium text-[#f8f8f8]">{m.user}</p>
                      <div className="rounded-[12px] bg-[#2a2d30] px-[14px] py-[10px]">
                        <p className="text-[13px] text-[#f8f8f8]">{m.text}</p>
                      </div>
                    </div>
                  </div>
                )}
          ...
          {/* Chat Input */}
          <div className="flex items-center gap-[10px] border-t border-[#2a2d30] bg-[#0e1012] px-[16px] py-[10px]">
            <button>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="#5d5d5d">
