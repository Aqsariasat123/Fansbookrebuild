      ...
      <div className="mx-[16px] w-full max-w-[580px] rounded-[22px] bg-foreground p-[20px] shadow-[0px_13px_142.4px_0px_rgba(0,0,0,0.25)] md:mx-0 md:p-[30px]">
        ...
        <div className="flex justify-center mt-[24px]">
          <button
            type="button"
            onClick={handleSave}
            className="bg-gradient-to-r from-[#01adf1] to-[#a61651] rounded-[80px] h-[45px] w-[306px] text-[20px] text-foreground cursor-pointer shadow-lg"
