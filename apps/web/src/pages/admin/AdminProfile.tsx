...
import { ChangePasswordModal } from './AdminChangePasswordModal';
        ...
        <div className="flex flex-col items-center">
          <div className="relative">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 flex size-[30px] items-center justify-center rounded-[20px] bg-[#2e4882]"
            >
              <img
