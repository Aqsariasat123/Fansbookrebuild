      ...
      <div className="min-h-0 w-full overflow-hidden bg-muted px-[20px] md:px-0">
        ...
        >
          ...
          <div className="flex w-full flex-col items-start gap-[15px] rounded-[16px] bg-card p-[20px] md:rounded-[22px] md:p-[32px]">
            ...
            <div className="flex w-full flex-col items-start">
              <div className="px-[15px] py-[10px]">
                <label className="text-[15px] md:text-[20px] font-normal text-foreground">
                  Name
                </label>
              </div>
              <input
                ...
                required
                className="w-full rounded-[7px] md:rounded-[12px] bg-muted py-[12px] md:py-[25px] pl-[15px] text-[15px] md:text-[20px] font-normal text-foreground placeholder-muted-foreground outline-none"
              />
            </div>
            ...
            <div className="flex w-full flex-col items-start">
              ...
              <textarea
                ...
                required
                className="h-[100px] md:h-[152px] w-full resize-none rounded-[7px] md:rounded-[12px] bg-muted py-[12px] md:py-[25px] pl-[15px] text-[15px] md:text-[20px] font-normal text-foreground placeholder-muted-foreground outline-none"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex items-center gap-[10px] rounded-[49px] md:rounded-[80px] px-[18px] py-[9px] md:px-[30px] md:py-[15px] text-[15px] md:text-[20px] font-medium text-white shadow-[0px_6px_10.1px_rgba(34,34,34,0.25)] disabled:opacity-60"
            style={{
              backgroundImage:
