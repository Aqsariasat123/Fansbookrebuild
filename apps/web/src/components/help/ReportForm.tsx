...
export function ReportForm() {
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      <p className="text-[16px] text-[#f8f8f8]">Report a Problem</p>

      <form onSubmit={handleSubmit} className="flex flex-col gap-[16px]">
        {/* Issue Title */}
        <div className="flex flex-col gap-[8px]">
          <label className="text-[18px] text-[#5d5d5d] capitalize">Issue Title</label>
          <div className="border border-[rgba(93,93,93,0.34)] rounded-[8px] h-[48px] w-full px-[16px] flex items-center">
            <input
              ...
              className="bg-transparent text-[12px] text-[#f8f8f8] outline-none placeholder:text-[#5d5d5d] w-full"
            />
          </div>
        </div>
        ...
        {/* Description */}
        <div className="flex flex-col gap-[8px]">
          <label className="text-[18px] text-[#5d5d5d] capitalize">Description</label>
          <div className="border border-[rgba(93,93,93,0.34)] rounded-[8px] h-[129px] w-full px-[16px] py-[12px]">
            <textarea
              placeholder="Enter Description..."
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              className="bg-transparent text-[12px] text-[#f8f8f8] outline-none placeholder:text-[#5d5d5d] w-full h-full resize-none"
            />
          </div>
        </div>
        ...
        <div className="flex justify-center mt-[4px]">
          <button
            type="submit"
            disabled={submitting}
            className="bg-gradient-to-r from-[#01adf1] to-[#a61651] rounded-[80px] h-[45px] w-[306px] text-[20px] text-[#f8f8f8] shadow-lg hover:opacity-90 transition-opacity disabled:opacity-50"
          >
