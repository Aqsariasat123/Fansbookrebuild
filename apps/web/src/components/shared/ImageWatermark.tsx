export function ImageWatermark({ username }: { username: string }) {
  return (
    <div className="pointer-events-none absolute bottom-[10px] right-[10px] inline-flex max-w-[300px] select-none items-center gap-[8px] rounded-[6px] bg-black/55 px-[12px] py-[6px]">
