/**
 * Golden spark-burst + sparkle reveal animation, played for ~1.1s when
 * PPV content is unlocked. Shared by the feed (PPVOverlay) and the public
 * profile (PostLockedImage). Keyframes live in index.css.
 */
        ...
        >
          <div
            ...
            style={{
              ...
              animation: 'rayBurst 0.8s cubic-bezier(0.2,0.7,0.25,1) forwards',
              opacity: 0,
            }}
          />
        </div>
